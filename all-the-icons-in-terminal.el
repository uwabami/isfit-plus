...
(require 'data-firacode-in-terminal     "./data/data-firacode-in-terminal.el")
(require 'data-linea-in-terminal        "./data/data-linea-in-terminal.el")
...
(require 'data-mfizz-in-terminal        "./data/data-mfizz-in-terminal.el")
(require 'data-octicons-in-terminal     "./data/data-octicons-in-terminal.el")
(require 'data-pomodoro-in-terminal     "./data/data-pomodoro-in-terminal.el")
...
(define-icon fracode    all-the-icons-in-terminal-data/firacode-alist       "icons-in-terminal")
(define-icon linea      all-the-icons-in-terminal-data/linea-alist          "icons-in-terminal")
...
(define-icon mfizz      all-the-icons-in-terminal-data/mfizz-alist          "icons-in-terminal")
(define-icon octicon    all-the-icons-in-terminal-data/octicons-alist       "icons-in-terminal")
(define-icon pomodoro   all-the-icons-in-terminal-data/pomodoro-alist       "icons-in-terminal")
